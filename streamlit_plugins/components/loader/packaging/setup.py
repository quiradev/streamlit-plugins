...
setup(
    ...
    packages=find_packages(include=["streamlit_plugins.components.loader", "streamlit_plugins.components.loader.*"]),
    ...
    options={
        'sdist': {'dist_dir': './dist/streamlit-plugins-component-loader'},
        'bdist_wheel': {'dist_dir': './dist/streamlit-plugins-component-loader'},
        'build': {'build_base': './build/streamlit-plugins-component-loader'}
    }
)
