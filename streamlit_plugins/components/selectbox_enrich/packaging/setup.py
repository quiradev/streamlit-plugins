...
setup(
    name='streamlit-component-selectbox-enrich',
    version=VERSION,
    license='MIT',
    ...
    packages=find_packages(include=[
        "streamlit_plugins.components.selectbox_enrich", "streamlit_plugins.components.selectbox_enrich.*"
    ]),
    python_requires='>=3.10',
    install_requires=requirements,
    include_package_data=True,
    package_data={
          "streamlit_plugins.components.selectbox_enrich": ["frontend/public/**/*"]
    },
    classifiers=[
    ...
    keywords=["streamlit", "plugins", "components", "selectbox-enrich"],
    options={
        'sdist': {'dist_dir': './dist/streamlit-plugins-component-selectbox-enrich'},
        'bdist_wheel': {'dist_dir': './dist/streamlit-plugins-component-selectbox-enrich'},
        'build': {'build_base': './build/streamlit-plugins-component-selectbox-enrich'}
    }
)
