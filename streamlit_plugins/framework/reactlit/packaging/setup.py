...
setup(
    name='streamlit-framework-reactlit',
    version=VERSION,
    license='MIT',
    ...
    packages=find_packages(include=["streamlit_plugins.framework.reactlit", "streamlit_plugins.components.reactlit.*"]),
    python_requires='>=3.9',
    ...
    keywords=["streamlit", "plugins", "framework", "reactlit"],
    options={
        'sdist': {'dist_dir': './dist/streamlit-plugins-framework-reactlit'},
        'bdist_wheel': {'dist_dir': './dist/streamlit-plugins-framework-reactlit'},
        'build': {'build_base': './build/streamlit-plugins-framework-reactlit'}
    }
)
